            ...
            switch(state.Value) {
                ...
                case State.Frying:
                    ...
                    if (fryingTimer.Value > fryingRecipeSO.fryingTimerMax) {
                        ...
                        SetBurningRecipeSOClientRpc(KitchenGameMultiplayer.Instance.GetKitchenObjectSOListIndex(GetKichenObject().GetKitchenObjectSO()));
                    }
                    break;
                case State.Fried:
        ...
        if (!HasKitchenObject()) {
            ...
            if (player.HasKitchenObject()) {
                ...
                if (HasRecipeWithInput(player.GetKichenObject().GetKitchenObjectSO())) {
                    // player carrying something that can be cook
                    KitchenObject kitchenObject = player.GetKichenObject();
                    kitchenObject.SetkitchenObjectParent(this);

                    InteractLogicPlaceObjectOnCounterServerRpc(KitchenGameMultiplayer.Instance.GetKitchenObjectSOListIndex(kitchenObject.GetKitchenObjectSO()));
                }
            } else {
